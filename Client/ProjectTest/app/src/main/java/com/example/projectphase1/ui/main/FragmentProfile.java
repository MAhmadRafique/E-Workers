...
public class FragmentProfile extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profile__balance = view.findViewById(R.id.profile_tv_wallet);
        tv_balance = view.findViewById(R.id.profile_tv_wallet_heading);
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                profile__balance.setVisibility(View.GONE);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                profile__balance.setVisibility(View.VISIBLE);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                classProfile=new ClassProfile(dataSnapshot.child(username).child("profile_username").getValue()+"",
                        ...
                        Integer.parseInt(dataSnapshot.child(username).child("wallet_value").getValue() + ""),
                        Integer.parseInt(dataSnapshot.child(username).child("membership_status").getValue() + ""));
                //Toast.makeText(getContext(),dataSnapshot.child(username).child("wallet_value").getValue() + "",Toast.LENGTH_SHORT).show();
              ...
              //  Toast.makeText(getContext(),"shoe",Toast.LENGTH_SHORT).show();
                ...
                profile__balance.setText(classProfile.getWallet_value() + "");
            }
