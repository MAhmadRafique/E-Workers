                                    ...
                                    if (termsNconditions.isChecked()) {
                                        ...
                                        databaseReference.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                {
                                                    show_toast("User exists. Login Now!");
                                                }
                                                else
                                                {
                                                    User user = new User();
                                                    ...
                                                    user.setWallet_value(100);
                                                    user.setMembership_status(0);
                                                    ...
                                                    db.child(user_name.getText().toString()).setValue(new ClassProfile(user_name.getText().toString(),name.getText().toString(),email.getText().toString(),"phone number","Adress", 100, 0));
