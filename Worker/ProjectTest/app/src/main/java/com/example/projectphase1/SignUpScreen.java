...
public class SignUpScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = FirebaseDatabase.getInstance().getReference().child("WorkerProfile");
                                        ...
                                        databaseReference.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                if (dataSnapshot.hasChild(user_name.getText().toString())) {
                                                    ...
                                                    db.child(user_name.getText().toString()).setValue(new ClassProfile(user_name.getText().toString(), name.getText().toString(), user.getSpeciality(), email.getText().toString(), "phone number", "Adress"));
