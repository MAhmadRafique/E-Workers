        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(name.getText().toString())) {
                    if (password.getText().toString().equals(dataSnapshot.child(name.getText().toString()).child("admin_Pass").getValue())) {
                        setDefaults("username", name.getText().toString(),SignInScreen.this);
                    ...
                    Toast.makeText(SignInScreen.this, "Incorrect Admin Name", Toast.LENGTH_LONG).show();
